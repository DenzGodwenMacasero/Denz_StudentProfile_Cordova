...
function displayProfile(profile) {
    ...
    const profileShortName = document.getElementById('profile-short-name');

    if (profileShortName) {
        profileShortName.textContent = shortName + '.';
    }
...
function openEditForm() {
    ...
    document.getElementById('about-me').value = profile.aboutMe;
...
function saveProfile() {
    ...
    if (course === '') {
        showMessage('Please enter your course.');
        return;
    }


    if (yearLevel === '') {
        showMessage('Please enter your year level.');
        return;
    }


    if (aboutMe === '') {
        showMessage('Please enter your about me information.');
        return;
    }
